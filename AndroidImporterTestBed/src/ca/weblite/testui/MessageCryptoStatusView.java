...
public class MessageCryptoStatusView extends Container  {
    public MessageCryptoStatusView(com.codename1.ui.util.Resources resourceObjectInstance) {
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">                          
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        setName("MessageCryptoStatusView");
        addComponent(gui_cryptostatusdotsbg);
        addComponent(gui_cryptostatuscombined2);
        addComponent(gui_cryptostatuscombined1);
        addComponent(gui_cryptostatussingle);
